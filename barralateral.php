  <div class="col s12 m4 l4">
    ...
    <div class="card painel-noticias">
      <?php query_posts('showposts=1&cat=260');?>
    ...
    <div class="card painel-noticias" style="margin-bottom: 23px;">
      <?php query_posts('showposts=1&cat=38');?>
      <?php if (have_posts()): while (have_posts()) : the_post();?>
      <a href="<?php the_Permalink()?>" title="<?php the_title();?>">
        <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'slider-noticias' ); ?>
        ...
        <div class="bloco-des-nogabinete">
            <a href="<?php the_Permalink()?>" title="<?php the_title();?>" class="green-text darken-4 center-align">
                <?php the_title();?>
            </a>
        </div>
        <div class="nocanto4 tamanho-icones">
...
<div class="card painel-artigo orange">
    <?php
    $args = array( 'post_type' => 'artigos', 'posts_per_page' => 1 );
