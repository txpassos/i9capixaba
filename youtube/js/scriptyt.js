	...
	function getVids(pid){
			...
			function(data){
				...
				$.each(data.items, function(i, item){
					...
					output = '<div class="col s12 m4 no-padding"><a class="modal-video" href="#modal1" data-video="https://www.youtube.com/embed/'+videoId+'"><div class="box-videos especiais-img b3" style="background: url(\'https://i.ytimg.com/vi/'+videoId+'/mqdefault.jpg\');border-radius: 2px 0 0 2px;"><i class="material-icons white-text">play_circle_outline</i><span class="titulo-especiais white-text">'+videoTitle+'</span></div></a></div>';
